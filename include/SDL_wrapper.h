...
inline auto renderClear(RendererPtr r) {
    return SDL_RenderClear(r);
}
inline auto renderPresent(RendererPtr r) {
    return SDL_RenderPresent(r);
}
inline auto renderDrawRect(RendererPtr r, Rect rect) {
    return SDL_RenderDrawRect(r, &rect);
}
inline auto renderFillRect(RendererPtr r, Rect rect) {
    return SDL_RenderFillRect(r, &rect);
}
inline auto renderFillRectF(RendererPtr r, FRect rect) {
    return SDL_RenderFillRectF(r, &rect);
}
inline auto setRenderDrawColor(RendererPtr ren, Uint8 r, Uint8 b, Uint8 g, Uint8 a) {
    return SDL_SetRenderDrawColor(ren, r, b, g, a);
}
...
inline constexpr SDL_Color Inferno = {211, 84, 0, 120};
